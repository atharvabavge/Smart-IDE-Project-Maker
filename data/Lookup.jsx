...
export default {
  ...
  SIGNIN_HEADING: 'Continue With SmartIDE',
  SIGNIN_SUBHEADING: 'To use SmartIDE you must log into an existing account or create one.',
  SIGNIn_AGREEMENT_TEXT: 'By using SmartIDE, you agree to the collection of usage data for analytics.',
...
`
  ...
  PRICING_OPTIONS:[
    ...
    },
    {
      ...
      tokens:'120K',
      value:120000,
      desc:'Designed for professionals who need to use SmartIDE a few times per week.',
      price:9.99
    },
    {
      name:'Pro',
